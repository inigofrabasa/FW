      ...
      return (
        <Fragment>
            <div className='stepsWrapperCtrl'>
              ...
              <div className='stepDotCtrl activeStepCtrl' id='step2' />
            ...
            <FormControl variant="outlined" className='selectFrmCtrl'>
                ...
                >
                  ...
                  <MenuItem value={30}>51-250</MenuItem>
                  <MenuItem value={30}>251-1000</MenuItem>
                  <MenuItem value={30}>1000+</MenuItem>
                </Select>
              </FormControl>
              <div className='spacerCtrl' />
            <div className='buttonsFloatCtrl'>
            <div className='secondaryButton floatedButtonCtrl noMarginCtrl'  onClick={()=>this.props.changeView(1)}>
                  Anterior
                </div>
                <div className='primaryButton floatedButtonCtrl noMarginCtrl'  onClick={()=>this.props.changeView(3)}>
                  Siguiente
                </div>
            </div>
            </div>
