      ...
      return (
        <Fragment>
            <div className='stepsWrapperCtrl'>
              ...
              <div className='stepDotCtrl activeStepCtrl' id='step3' />
            ...
            <div className='secondaryButton floatedButtonCtrl noMarginCtrl' onClick={()=>this.props.changeView(2)}>
                  Anterior
                </div>
                <div className='primaryButton floatedButtonCtrl noMarginCtrl' onClick={()=>this.props.changeView(4)}>
                  Siguiente
                </div>
            </div>
            </div>
